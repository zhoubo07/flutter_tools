...
public final class StringUtils {
    ...
    public static boolean isEmptyAndNull(final CharSequence s){
        return isEmpty(s)||s.equals("null")||s.equals("\"null\"");
    }
    ...
    public static CharSequence stringFromHtml(String str) {

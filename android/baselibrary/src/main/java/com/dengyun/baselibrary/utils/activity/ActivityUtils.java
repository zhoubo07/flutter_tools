package com.dengyun.baselibrary.utils.activity;
...
/**
 ...
 setBackgroundAlpha             : 设置activity背景透明度

 * @titile  activity相关工具类
...
public final class ActivityUtils {
     ...
     * @param clz      The activity class.
     */
    public static void startActivity(@NonNull final Bundle options,

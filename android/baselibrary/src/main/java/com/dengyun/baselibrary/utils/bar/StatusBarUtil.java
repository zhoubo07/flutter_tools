package com.dengyun.baselibrary.utils.bar;
...
public class StatusBarUtil {
    ...
    /**
     * 设置亮色模式的状态栏文字颜色（文字颜色为深色）
     */
    @TargetApi(Build.VERSION_CODES.M)
    public static void setLightTextMode(Activity activity) {
        setMIUIStatusBarDarkIcon(activity, true);
        setMeizuStatusBarDarkIcon(activity, true);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            int systemUiVisibility = activity.getWindow().getDecorView().getSystemUiVisibility();
            activity.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR | systemUiVisibility);
        }
    }

    /**
     * 设置暗色模式的状态栏文字颜色（文字颜色为亮色）
     */
    @TargetApi(Build.VERSION_CODES.M)
    public static void setDarkTextMode(Activity activity) {
        setMIUIStatusBarDarkIcon(activity, false);
        setMeizuStatusBarDarkIcon(activity, false);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            int systemUiVisibility = activity.getWindow().getDecorView().getSystemUiVisibility();
    ...
    public static int getStatusBarHeight() {
        ...
        return Utils.getApp().getResources().getDimensionPixelSize(resourceId);
    }
